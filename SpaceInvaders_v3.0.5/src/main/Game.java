...
public class Game extends JPanel {
    ...
    private Random rGen;
    private int rayCoolDown = 700;
    private long lastTimeRayGenerated;
    private int rayCoolDownDecrease = 11;
    ...
    public boolean colide(float[] h, float[] g){
    ...
    public void changeScore(AlienType type){
        switch (type){
            case OCTOPUS:
    ...
    private void tornaPantallaInici(){
        ...
        Starter.parentPanel.add(pInici);
        Starter.parentPanel.repaint();
        Starter.parentPanel.revalidate();
        pInici.requestFocusInWindow();
    }
